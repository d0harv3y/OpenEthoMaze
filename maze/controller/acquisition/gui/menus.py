...
def build_main_window_menus(window, *, reload_last_profile_checked: bool) -> None:
    ...
    file_menu.addAction("Load profile…", window._on_load_profile)
    file_menu.addAction("Save profile", window._on_save_profile)
    file_menu.addAction("Save profile as…", window._on_save_profile_as)
    file_menu.addAction("Open profile in editor", window._on_open_profile_in_editor)
    file_menu.addAction("Reload profile", window._on_reload_profile)
    file_menu.addSeparator()
    ...
    settings_menu.addAction("Settings…", window._on_settings)

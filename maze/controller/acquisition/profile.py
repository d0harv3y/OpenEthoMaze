...
def _fallback_tracking_to_dict(c: "FallbackTrackingConfig") -> Dict[str, Any]:
    return {
        ...
        "node_jump_confirm_frames": c.node_jump_confirm_frames,
...
def _fallback_tracking_from_dict(d: Dict[str, Any]) -> "FallbackTrackingConfig":
    return FallbackTrackingConfig(
        ...
        node_jump_confirm_frames=max(1, int(d.get("node_jump_confirm_frames", 2))),
...
def config_from_dict(d: Dict[str, Any]) -> ControllerConfig:
    ...
    common_kwargs = dict(
        ...
        arena_type=str(d.get("arena_type", "circular") or "circular"),
        ...
        track_exit_either_success=bool(d.get("track_exit_either_success", False)),

...
Example::
    ...
    uv run python scripts/trial_summary_data_dictionary.py --db path/to/vast_results.h5
...
from maze.pipeline.exports.trial_summary_dictionary import (  # noqa: E402
    write_trial_summary_dictionary_tsv,
)
from maze.pipeline.paths import OUTPUT_H5  # noqa: E402

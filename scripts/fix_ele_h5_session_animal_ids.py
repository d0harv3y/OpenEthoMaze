...
Usage:
    uv run python scripts/fix_ele_h5_session_animal_ids.py PATH\\to\\file.hdf5 --dry-run
    uv run python scripts/fix_ele_h5_session_animal_ids.py PATH\\to\\file.hdf5 \\

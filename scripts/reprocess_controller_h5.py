...
Example (PowerShell, from the ORM repo root)::
    ...
    uv run python scripts/reprocess_controller_h5.py path\\to\\controller.h5
    uv run python scripts/reprocess_controller_h5.py path\\to\\controller.h5 --animal-id 1 --session S01 --trial T01 --no-qc
"""

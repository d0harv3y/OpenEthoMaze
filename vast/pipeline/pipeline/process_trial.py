...
def _process_with_sleap(
    ...
    for point_name in AMBIULATION_POINT_NAMES:
        ...
        exit_run = calculate_exit_metrics(
            xy=xy_run,
            valid=valid_run,
            exit_pos=exit_pos,
            px_per_cm=settings.px_per_cm,
        ...
        center_run = calculate_center_metrics(
            xy=xy_run,
            valid=valid_run,
        ...
        run_summary = {
            ...
            "latency_to_exit_s": exit_run.latency_to_exit_s,
            "time_in_exit_zone_s": exit_run.time_in_exit_zone_s,
            "time_in_exit_zone_fraction": exit_run.time_in_exit_zone_fraction,
            "mean_distance_to_exit_cm": exit_run.mean_distance_to_exit_cm,
            "min_distance_to_exit_cm": exit_run.min_distance_to_exit_cm,
            "path_efficiency": exit_run.path_efficiency,
            "n_exit_zone_entries": exit_run.n_exit_zone_entries,
            "time_in_center_s": center_run.time_in_center_s,
        ...
        if start_frame > 0 and xy_iti.shape[0] > 0:
            ...
            exit_iti = calculate_exit_metrics(
                xy=xy_iti,
                valid=valid_iti,
                exit_pos=exit_pos,
                px_per_cm=settings.px_per_cm,
            ...
            center_iti = calculate_center_metrics(
                xy=xy_iti,
                valid=valid_iti,
                arena_center_pos=arena_center,
                px_per_cm=settings.px_per_cm,
            ...
            band_summaries.append({
                ...
                "latency_to_exit_s": exit_iti.latency_to_exit_s,
                "time_in_exit_zone_s": exit_iti.time_in_exit_zone_s,
                "time_in_exit_zone_fraction": exit_iti.time_in_exit_zone_fraction,
                "mean_distance_to_exit_cm": exit_iti.mean_distance_to_exit_cm,
                "min_distance_to_exit_cm": exit_iti.min_distance_to_exit_cm,
                "path_efficiency": exit_iti.path_efficiency,
                "n_exit_zone_entries": exit_iti.n_exit_zone_entries,
                "time_in_center_s": center_iti.time_in_center_s,
                "time_in_center_fraction": center_iti.time_in_center_fraction,
                "n_center_entries": center_iti.n_center_entries,
            })
